...
const Mission = () => {
  return (
    <section className="about-section" style={{ background: '#0b1220', color: '#e5eefb' }}>
      <div className="container">
        <div className="about-grid">
          <div className="about-grid__text">
            <h2 className="reveal reveal--fade-up" style={{ color: '#9ec1ff' }}>Misión</h2>
        ...
        <div className="about-grid" style={{ marginTop: 28 }}>
          ...
          <div className="about-grid__text">
            <h2 className="reveal reveal--fade-up" style={{ color: '#9ec1ff' }}>Visión</h2>
